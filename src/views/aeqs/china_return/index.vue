        ...
        <div class="container_outside">
          <div class="feedbackContainer">
            ...
            <div class="content" v-if="!pageIndex">
              ...
              <div class="searchContainer">
                <div class="searchbox">
                  <a-form :model="form">
                    <a-row :gutter="16">
                      <a-col :span="6">
                        <a-form-item field="category" label="Category" label-col-flex="100px">
                          <a-input v-model="form.category" placeholder="请输入Category" />
                        </a-form-item>
                      </a-col>
                      <a-col :span="6">
                        <a-form-item field="shoesType" label="鞋型名称" label-col-flex="80px">
                          <a-input v-model="form.shoesType" placeholder="请输入鞋型名称" />
                        </a-form-item>
                      </a-col>
                      <a-col :span="6">
                        <a-form-item field="art" label="ART" label-col-flex="80px">
                          <a-input v-model="form.art" placeholder="请输入ART" />
                        </a-form-item>
                      </a-col>
                      <a-col :span="6">
                        <a-form-item field="noShshoes" label="新鞋/旧鞋 " label-col-flex="100px">
                          <a-select v-model="form.noShshoes" placeholder="请选择活动区域">
                    ...
                    <a-row :gutter="16">
                      ...
                      <a-col :span="6">
                        <a-form-item field="returnReason" label="主要退货原因" label-col-flex="100px">
                          <a-input v-model="form.returnReason" placeholder="请输入主要退货原因" />
                        </a-form-item>
                      </a-col>
                      <a-col :span="6">
                        <a-form-item field="productDate" label="生产月份" label-col-flex="80px">
                          <a-month-picker placeholder="选择日期" v-model="form.productDate" format="YYYY-MM"
                      ...
                      <a-col :span="12">
                        <a-form-item label="退货月份" required>
                          <a-col :span="11">
                            ...
                            <a-month-picker placeholder="----年~月" v-model="form.returnDate1" field="returnDate1"
                              format="YYYY-MM" style="width: 100%;" :rules="{
                                required: true, message: '退货日期不能为空', trigger: 'blur'
                              }"></a-month-picker>
                          </a-col>
                          <a-col class="line" :span="2" style="display: flex;justify-content: center;">-</a-col>
                          <a-col :span="11">
                            <!-- <a-date-picker></a-date-picker> -->
                            <a-month-picker placeholder="----年~月" v-model="form.returnDate2" field="returnDate2"
                              format="YYYY-MM" style="width: 100%;"></a-month-picker>
                          </a-col>
                        </a-form-item>
                      </a-col>
                    </a-row>
                ...
                <div class="searchButton">
                  <a-button type="primary" style="width: 140px;height: 40px;" @click="getMainContent()">查询</a-button>
                  <a-button type="primary" style="width: 140px;height: 40px;" @click="reSet">重置查询</a-button>
                </div>
              </div>
              <!-- 内容 -->
              <div class="contentBox">
                ...
                <div class="contentLeft common common1">
                  <div class="leftTop commontitle  " @click="GotoMainDetail(1, '退货主要原因明细')">
                    <div class="headtitle commonflex">退货主要原因</div>
                    <div class="common">
                      <dv-border-box-13 class="dv-border-box-12 ">
                        <dv-scroll-board :config="config" class="board-info" style="height: 240px;"></dv-scroll-board>
                      </dv-border-box-13>
                    </div>
                  ...
                  <div class="leftMid  commontitle">
                    ...
                    <div class="common">
                      <dv-border-box-13 class="dv-border-box-12 commonflex">
                        <VCharts :option="returnOption" style="width: 100%;height: 240px"></VCharts>
                      </dv-border-box-13>
                    </div>

                  </div>
                  <div class="leftBottom   commontitle" @click="GotoMainDetail(2, '退货ART明细')">
                    <div class="headtitle commonflex">退货前十ART</div>
                    <div class="common">
                      <dv-border-box-13 class="dv-border-box-12 commonflex">
                        <VCharts :option="reaturnLead" style="width: 100%;height: 240px"></VCharts>
                      </dv-border-box-13>
                    </div>
                ...
                <div class="contentMid  common1">
                  <div class="midT">
                    <VCharts :option="reaturnProOption" style="width: 100%;height: 570px"></VCharts>
                  </div>
                  <div class="midB">
                    <div class="midL common  commontitle">
                      ...
                      <div class="common">
                        <dv-border-box-13 class="dv-border-box-12 ">
                          <VCharts :option="factoryoption" style="width: 100%;height: 240px"></VCharts>
                        </dv-border-box-13>
                      </div>
                    </div>
                      ...
                      <div class="common">
                        <dv-border-box-13 class="dv-border-box-12 commonflex">
                          <div class="midrL commonflex common">
                            <VCharts :option="newShoeProOption" style="width: 100%;height: 240px"></VCharts>
                          </div>
                          <div class="midrR commonflex common">
                            <VCharts :option="oldShoeProOption" style="width: 100%;height: 240px"></VCharts>
                          </div>
                        </dv-border-box-13>
                ...
                <div class="contentRight common common1">
                  <div class="rightTop common commontitle" @click="GotoMainDetail(3, '生产线退货明细')">
                    ...
                    <div class="common">
                      ...
                      <dv-border-box-13 class="dv-border-box-12 cmmon1">
                        <div>
                          <div style="width: 380px;height: 20px;background-color: rgb(0, 186, 255);" class="tablerow">
                            <p>排名</p>
                            <p>组别</p>
                            <p>数量和占比</p>
                          </div>

                          <dv-scroll-ranking-board :config="reproConfig" class="ranking-info"
                  ...
                  <div class="rightTopMid common commontitle" @click="GotoMainDetail(4, '鞋型退货明细')">
                    ...
                    <div class="common">
                      <dv-border-box-13 class="dv-border-box-12 ">
                        <div>
                          ...
                          <dv-scroll-ranking-board :config="shoesTypeConfig" class="ranking-info midRanking"
                            style="width:350px;height: 220px;" />
                        </div>
                  ...
                  <div class="rightTopBottom common commontitle" @click="GotoMainDetail(5, '鞋型退货率')">
                    ...
                    <div class="common">
                      <dv-border-box-13 class="dv-border-box-12 ">
                        <div>
                          ...
                          <dv-scroll-ranking-board :config="shoesTypepro" class="ranking-info BotRanking"
                            style="width:350px;height: 220px;" />
                        </div>
            ...
            <div class="returnDetail" v-if="pageIndex">
              <div class="content">
                <a-table :columns="headlist" :data="tableData" :pagination="false" :default-page-size='17'
                  :hoverable="false" :bordered="false" :row-class="tableRowClassName" style="width: 100%" />

              </div>
              <a-pagination :total="dataTotal" :page-size-options="[5, 10, 17]" show-total show-jumper show-page-size
                :default-page-size='17' class="pagechange" @change="handleCurrentChange"
...
const form = ref({
  ...
  detail_type: '',
  title: '',
  returnDate1: formatDate(new Date(new Date().getFullYear(), new Date().getMonth() - new Date().getMonth())),
...
const reaturnProOption = reactive<any>({
  ...
  legend: {
    ...
    bottom: 15,
    left: 0,
    data: ["去年退货数量", "今年退货数量", "去年中国区占比", "今年中国区占比"]
  },
  xAxis: [
    {
      type: "category",
  ...
  series: [
    ...
    },
    {
      ...
      data: [
        12.5, 10, 22, 20, 30, 40, 30, 44, 55, 60, 60, 0
      ],
      itemStyle: {
        color: "#f4b183"
      }
...
async function getMaindetail(formparm: any) {
  ...
  let months: any[] = []
  months = generateMonthsBetween(form.value.returnDate1, form.value.returnDate2)
  console.log(months);
  let maindetial = []
  ...
  if (dataTotal.value) {
    ...
    if (String(form.value.detail_type) !== '5') {
      maindetial.map(((item: any, indexI: any) => {
        ...
        item.RETURNCOUNT = item.RETURN_MONTH.includes(',') ? item.RETURNCOUNT.split(', ') : [item.RETURNCOUNT]
        item.RETURN_MONTH = item.RETURN_MONTH.includes(',') ? item.RETURN_MONTH.split(', ') : [item.RETURN_MONTH]
      ...
      let headlistdt = []
      headlist.value = []
      headlistdt = Object.keys(maindetial[0]).filter(item => item !== "RETURNCOUNT" && item !== "RETURN_MONTH" && item !== "total");
  ...
  if (String(form.value.detail_type) === "3") {
    ...
    sortedMaindetail = maindetial
    sortedMaindetail.sort((a: any, b: any) => {
      const isMainAEmpty = a["厂线代码"] === null || a["厂线代码"] === '' || a["厂线代码"] === "其它";
      const isMainBEmpty = b["厂线代码"] === null || b["厂线代码"] === '' || b["厂线代码"] === "其它";
      if (isMainAEmpty && !isMainBEmpty) return 1;
      if (!isMainAEmpty && isMainBEmpty) return -1;
...
async function getMainContent() {
  ...
  *退货前十ART
  ...
  if (facdt.length > 0) {
    ...
    let colors: any[] = []
    colors = ['#e69a03', '#e65c2f', '#06c7e8', '#0268e5', '#008be7', '#8b665c', '#aa938c', '#5cb8b9']

    if (facdt.length - colors.length > 0) {
      colors.push([...generateUniqueRandomColors(facdt.length - colors.length)])
    }

    facConfig.series[0].data[0].children = facdt.map((item: any, index: any) => ({
  ...
  */
  ...
  if (newoldt.RETURNCOUNT !== 0) {
    ...
    oldShoeProOption.series[0].label.normal.formatter = `旧鞋\n${(Math.round(newoldt.OLDSUM / (newoldt.OLDSUM + newoldt.NEWSUM) * 100))}%`;
    newShoeProOption.series[0].label.normal.formatter = `新鞋\n${(Math.round(newoldt.NEWSUM / (newoldt.OLDSUM + newoldt.NEWSUM) * 100))}%`;
  }
  else {
  ...
  */
  ...
  shoesprodt = result.data.shoesSeries.map((item: any) => ({
    name: item.SHOSE_NAME,
    value: item.TOTAL_SHIPPING_QTY ? parseFloat(((item.RETURNCOUNT / item.TOTAL_SHIPPING_QTY) * 100).toFixed(2)) : (0).toFixed(2)
  }));
...
async function getYearReturn() {
  ...
  returnNumbers.forEach((item, index) => {
    return returnNumberspro.push(lastreturnNum[index] ? parseFloat((item / (lastreturnNum[index]) * 100).toString()).toFixed(2) : parseFloat(parseFloat((lastreturnNum[index])).toString()).toFixed(2));
  });
