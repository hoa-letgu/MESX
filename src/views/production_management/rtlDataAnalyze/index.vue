    ...
    <a-layout>
      <a-layout-header class="headText">
        <a-row class="HeadTitle">
          <div>{{ $t('menu.production_management.搜索区') }}</div>
        </a-row>
        <a-row :gutter="24" class="HeadContext" :wrap="true">
          ...
          <a-col :span="4">
            <div class="HeadContext">
              <div>{{ $t('menu.production_management.工厂') }}:</div>
              <div>
                <a-select
                  v-model="factCode"
                  :style="{ width: '160px' }"
          ...
          <a-col :span="4">
            <div class="HeadContext">
              <div>{{ $t('menu.production_management.厂区') }}:</div>
              <div>
                <a-select
                  v-model="orgCode"
                  :style="{ width: '160px' }"
          ...
          <a-col :span="4">
            <div class="HeadContext">
              <div>{{ $t('menu.production_management.类型') }}:</div>
              <div>
                <a-select
                  v-model="typeDate"
                  :style="{ width: '160px' }"
          ...
          <a-col :span="4">
            <div class="HeadContext">
              <div>{{ $t('menu.production_management.日期') }}:</div>
              <div>
                <a-date-picker
                  v-model="startDate"
                  style="width: 200px"
          ...
          <a-col :span="4">
            <div class="HeadContext">
              <div>{{ $t('menu.production_management.至') }}:</div>
              <div>
                <a-date-picker
                  v-model="endDate"
                  style="width: 200px"
          ...
          <a-col :span="5" :offset="19">
            <a-space>
              <a-button type="primary" @click="seachBtn">{{
                $t('menu.production_management.查询')
              }}</a-button>
              <a-button type="primary" @click="clearBtn">{{
                $t('menu.production_management.重置查询')
              }}</a-button>
            </a-space>
          </a-col>
        </a-row>
...
<script lang="ts" setup>
  ...
  planText.value = t('menu.production_management.计划目标达成率');
