...
// 查询退货信息
export async function queryReturnInfo(param: any) {
  const result: ResponseResult = { data: [], msg: '', status: true };
  const data: ResultParameter = await scmpost(
    'KZ_MESAPI',
    'KZ_MESAPI.Controllers.WorkCenterDashboardServer',
...
// 获取厂区面底排单信息
export async function GetScheduleInfo(vOrgCode: string) {
  const result: ResponseResult = { data: [], msg: '', status: true };
  const data: ResultParameter = await scmpost(
    'KZ_MESAPI',
    'KZ_MESAPI.Controllers.WorkCenterDashboardServer',
...
// 获取厂区生产组别面底排单信息
export async function GetLineScheduleInfo(vLineCode: string, vOrgCode: string) {
  const result: ResponseResult = { data: [], msg: '', status: true };
  const data: ResultParameter = await scmpost(
    'KZ_MESAPI',
    'KZ_MESAPI.Controllers.WorkCenterDashboardServer',
...
// 获取组别配套排单订单
export async function GetLineOrderInfo(vLineCode: string) {
  const result: ResponseResult = { data: [], msg: '', status: true };
  const data: ResultParameter = await scmpost(
    'KZ_MESAPI',
    'KZ_MESAPI.Controllers.WorkCenterDashboardServer',
...
// 获取订单尺码排单明细
export async function GetSizeOrderInfo(vLineCode: string, vWorkDay: string, vPO: string, vArtNo: string) {
  const result: ResponseResult = { data: [], msg: '', status: true };
  const data: ResultParameter = await scmpost(
    'KZ_MESAPI',
    'KZ_MESAPI.Controllers.WorkCenterDashboardServer',
